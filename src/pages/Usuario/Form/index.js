    ...
    <Wrapper>
      ...
      <Content>
        <Form onSubmit={(event) => handleSubmit(event)}>
          ...
          >
            <option name="evento" value="" disabled>
              Selecione um evento
            </option>
            {eventos.map((item) => {
              return (
                <option
                  ...
                  name="id_evento"
                  value={item.id}
                  selected={usuario.evento === item.id ? "selected" : ""}
                >
                  {" "}
                  {item.titulo}
                </option>
          ...
          <FormGroup>
            ...
            <Select
              ...
              onChange={(event) => handleOnChange(event)}
            >
              <option name="permissao" value="" disabled>
                Selecione uma opção
              </option>
              <option
                name="permissao"
              ...
              <option
                name="permissao"
                selected={
                  usuario.permissao === "comum" || usuario.permissao === "Comum"
                    ? "selected"
                    : ""
                }
                value="Comum"
